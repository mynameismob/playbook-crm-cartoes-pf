...
def extract_data(file_path):
    ...
    try:
        ...
        # Ajustar conforme a estrutura real da aba se necessário
...
data = extract_data('/home/ubuntu/upload/Dicionário-CDP(Adobe)-Copiar.xlsx')
with open('/home/ubuntu/cdp_data.json', 'w', encoding='utf-8') as f:
